 ...
 * Maneja autenticación, registro, actualización de perfil y gestión de cuentas.
 * Coordina con UserService y Authenticator para ejecutar la lógica de negocio.
 *
...
class UserController
{
     ...
     *
     * Inicializa el servicio de usuarios y el autenticador
     */
    ...
    /**
     * Acción: Listar usuarios con búsqueda y paginación
     *
     * GET /users?search={query}
     * Si hay parámetro de búsqueda, busca usuarios por nombre.
     * Si no, muestra usuarios con paginación.
     *
     * @return void
     */
    public function listUsers(): void
    {
        ...
        if (!empty($searchTerm)) {
            ...
            $users = $this->userService->paginate(5,1);
        }
    ...
    /**
     * Acción: Mostrar formulario de registro
     *
     * GET /register
     ...
     * Redirige al login si es exitoso o muestra errores.
     *
     * @return void
     */
    #[NoReturn]
    ...
    /**
     * Acción: Mostrar formulario de inicio de sesión
     *
     * GET /login
    ...
    /**
     * Acción: Procesar inicio de sesión
     *
     * POST /login
    ...
    /**
     * Acción: Mostrar dashboard de usuario
     *
    ...
    /**
     * Acción: Actualizar perfil de usuario
     *
     * POST /dashboard/update (Requiere autenticación)
     * Actualiza nombre, email y opcionalmente la contraseña del usuario
     *
     * @return void
     */
    #[NoReturn]
     ...
     *
     * POST /dashboard/delete (Requiere autenticación)
